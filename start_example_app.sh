...
cd example_app/demo && bin/supervisord start -supvr.exit_when_all_done true DEMO -supvr.stdout log/stdout.log ./bin/example_app  --run_timeout 60  --swallow_signal TERM
